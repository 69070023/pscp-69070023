...
```text
โจทย์ต้องการรับราคาอาหารมาคิด SC 10% โดยมีเงื่อนไขว่า SC ต้องไม่ต่ำกว่า 50 บาทและไม่เกิน 1,000 บาทจากนั้นเอายอด (ราคาอาหาร + SC) ไปคิด VAT ทบเพิ่มอีก 7% เพื่อเป็นยอดจ่ายสุทธิ
ดังนั้นสรุปก็คือ
Input: ราคาอาหารที่เป็น int 1 บรรทัด
Output: ยอดชำระสุทธิ ที่ต้องแสดงผลเป็นทศนิยม 2 ตำแหน่ง
```
...
```text
Step 1: รับค่าอาหาร
Step 2: คำนวณ 10% ของค่าอาหาร
Step 3: ใช้ if-elif บีบค่า SC ให้อยู่ในช่วง 50 ถึง 1000
Step 4: เอาราคาอาหาร + เซอวิชชาจ
Step 5: คิด VAT 7% ทบเข้าไปเป็นยอดจ่าย
Step 6: พิมพ์ผลลัพธ์ ทศนิยม 2 ตำแหน่ง
```
...
```text
วิธีที่ใช้จริงคือการคำนวณทางคณิตศาสตร์เป็นลำดับขั้นตามปกติร่วมกับการใช้เงื่อนไข if-elif เพื่อตรวจสอบช่วงของค่าบริการ
```
...
```text
เพื่อเช็คว่าถ้ายอด 10% ต่ำกว่า 50 บาท ระบบจะปัดขึ้นเป็น 50 บาทให้ถูกต้องไหม
```
...
```text
เพื่อเช็คเรทปกติที่ยอด 10% อยู่ในช่วง 50-1000 บาทพอดี ว่าโปรแกรมไม่ได้ไปเผลอปัดเศษอะไรทิ้ง
```
...
```text
เพื่อเช็คว่าถ้ายอดสั่งอาหารเยอะมากๆ จน 10% เกิน 1,000 บาท ระบบจะล็อกเก็บค่าบริการไว้ที่ 1,000 บาทเป๊ะๆรึป่าว
```
