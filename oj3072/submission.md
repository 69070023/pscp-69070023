...
```text
โจทย์ให้รับข้อความสตริงเข้ามา 1 บรรทัด แล้วนับว่ามีสระภาษาอังกฤษตัวไหนอยู่บ้าง และแต่ละตัวมีจำนวนกี่ตัว

- Input: ข้อความภาษาอังกฤษ 1 บรรทัด (อาจมีทั้งตัวพิมพ์เล็ก ตัวพิมพ์ใหญ่ ตัวเลข หรือสัญลักษณ์)
- Output: แสดงชื่อสระและจำนวนที่พบ เฉพาะสระที่มีอยู่ในข้อความ โดยนับรวมทั้งตัวพิมพ์เล็กและตัวพิมพ์ใหญ่เข้าด้วยกัน

เงื่อนไขคือต้องแปลงตัวอักษรให้เป็นเคสเดียวกันก่อนนับ และตอนแสดงผลให้เรียงตามลำดับอักษรของสระ
```
...
```text
1. รับข้อความเข้ามา แล้วแปลงให้เป็นตัวพิมพ์เล็กทั้งหมด
2. วนลูปอ่านตัวอักษรทีละตัวในข้อความ
3. เช็คว่าตัวอักษรนั้นเป็นสระ (a, e, i, o, u) ไหม ถ้าใช่ให้นับสะสมไว้
4. แสดงผลสระที่มีจำนวนมากกว่า 0 ออกมาทีละบรรทัด
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรกครับ เพราะตรรกะการวนลูปเช็คสระทีละตัวอักษรเป็นวิธีที่ตรงไปตรงมา รันผ่านได้เร็ว และได้คำตอบถูกต้องตรงตามโจทย์
```
...
```text
ทดสอบข้อความทั่วไปที่มีสระผสมกันอยู่ 2 ชนิด เพื่อดูการนับและการแสดงผลเบื้องต้น
```
...
```text
ทดสอบข้อความที่มีสัญลักษณ์และจุดเชื่อม เพื่อดูว่าโปรแกรมข้ามตัวอักษรที่ไม่ใช่สระได้ถูกต้องไหม
```
...
```text
ทดสอบข้อความที่มีตัวพิมพ์ใหญ่ผสม (A พิมพ์ใหญ่) เพื่อเช็คว่าโปรแกรมแปลงเป็นตัวพิมพ์เล็กแล้วนับรวมกันได้จริงไหม
```
