...
```text
โจทย์ข้อนี้คือการหาจำนวนหินขนาด 1 ที่ต้องใช้ในการต่อให้ได้ความยาวตามเป้า โดยมีหินขนาด 5 มาช่วยแบ่งเบาความยาวด้วย

อินพุตรับมา 3 บรรทัด เป็นจำนวนหินเล็ก หินใหญ่ และความยาวเป้าหมาย เอาต์พุตแสดงจำนวนหินเล็กที่ต้องใช้จริง หรือแสดง -1 ถ้าทำไม่ได้

เงื่อนไขคือต้องเลือกใช้หินก้อนใหญ่ก่อนเสมอเท่าที่ไม่เกินเป้าหมาย แล้วค่อยเอาเศษที่เหลือมาดูว่าหินเล็กที่มีอยู่พอไหม ถ้าหินทั้งหมดรวมกันยาวไม่พอ หรือหินเล็กมีไม่พอเติมเศษที่ขาด ก็ให้คืนค่า -1 ออกมา
```
...
```text
วางโค้ดคร่าวๆ ไว้ประมาณนี้:

1. รับค่า small, big, target
2. เช็คก่อนว่าความยาวหินทั้งหมดที่มีน้อยกว่า target ไหม ถ้าใช่ตอบ -1 ทันที
3. คำนวณหินใหญ่ที่ต้องใช้ = เลือกค่าที่น้อยกว่าระหว่าง (big) กับ (target หารเอาส่วนด้วย 5)
4. หาความยาวที่เหลือ = target ลบด้วย (หินใหญ่ที่ใช้ คูณ 5)
5. ถ้า ความยาวที่เหลือ น้อยกว่าหรือเท่ากับ small ให้ตอบ ความยาวที่เหลือ
6. ถ้า ความยาวที่เหลือ มากกว่า small ให้ตอบ -1
```
...
```text
วิธีที่ใช้จริงเหมือนกับแผนแรกเลยครับ เพราะแนวคิดการดึงหินก้อนใหญ่มาใช้ก่อนเป็นวิธีที่ตรงไปตรงมาที่สุด ในโค้ดจะคำนวณหินก้อนใหญ่ที่ใช้จริงโดยเลือกค่าน้อยสุดระหว่างหินใหญ่ที่มีกับเป้าหมายหารด้วย 5 จากนั้นเอาเศษความยาวที่เหลือมาดูว่าหินเล็กที่มีอยู่พอไหม ถ้าพอก็ตอบจำนวนเศษนั้นไป ถ้าไม่พอก็ตอบ -1
```
...
```text
ทดสอบการทำงานทั่วไปกรณีที่ต้องใช้ทั้งหินก้อนใหญ่และหินก้อนเล็กผสมกันแล้วได้ตามเป้าหมายพอดี
```
...
```text
ทดสอบกรณีที่หินก้อนใหญ่ต่อได้พอดีตามเป้าหมาย ทำให้ไม่ต้องดึงหินก้อนเล็กมาใช้เลย เพื่อเช็คว่าโปรแกรมคืนค่า 0 ได้ถูกต้องไหม
```
...
```text
ดักเคสที่คนมักจะเขียนผิดกัน คือถ้าดูความยาวรวมหินทั้งหมดจะเหมือนว่าพอ (2*5 + 2 = 12 ซึ่งมากกว่า 8) แต่จริงๆ พอหักหินใหญ่ไป 1 ก้อนแล้ว เศษที่เหลือคือ 3 แต่เรามีหินเล็กแค่ 2 ก้อน ทำให้ต่อไม่ได้จริง ต้องตอบ -1
```
