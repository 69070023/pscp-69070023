...
```text
input : รับ input เป็น int ตัวแทนของวันและเดือน
output: print ฤดูที่วันและเดือนนั้นคือฤดูใด
constraints : เดือนใส่เป็นตัวเลขที่จะใส่เป็นชื่อเดือน
```
...
```text
1. input 2 ตัว วันและเดือน
2. condition หากวันนี้เป็นเดือนนี้จะเป็นฤดูใด
3. condition ว่าตรงกับวันที่ต้องเปลี่ยนฤดูรึเปล่า
4. print ออกมาเป็นฤดูใด
```
...
```text
รับ input เป็นปีและเดือน, เข้า condition ว่าต้องเป็นฤดูใดและดูว่าตรงกับวันที่ต้องเปลี่ยนฤดูแและ print ออกมาเป็นฤดูที่ตรงกับ condition
```
...
```text
เพราะวันที่มากกว่า 21 และหาร 3 ไม่ลงตัว
```
...
```text
เนื่องจากเป็นเดือนที่หาร 3 ลงตัวแต่วันก่อน 21
```
