...
```text
input คือใส่ตัวอักษร
output คือทำให้ตัวอักษรมันสลับจากหลังมาหน้าและก็ต้องเป็นตัวเล็กทั้งหมด ผมเลยใช้ [::-1] เพื่อทำให้ตัวอักษรมันกลับจากหน้าเป็นหลังและใช้ .lower() ในการทำให้เป็นเล็กทั้งหมด
```
...
```text
1.รับข้อมูลมาก่อน
2.สลับตำแหน่งแหน่ง [::-1]
3.แสดงผลเป็นตัวเล็กใช้ .lower()
```
...
```text
ใช้ [::-1] ควบคู่กับ .lower() เพราะตอนแรกผมก็จะทำเป็นลูปตรวจตัวอักษรทีละตัว แต่เพื่อไม่ให้โค้ดมันยาวและอ่านง่ายเลยใช้วิธีนี้ครับ
```
