...
```text
โจทย์ให้เราคำนวณราคาสินค้ารวมพร้อมคิดส่วนลดและปัดเศษทศนิยมให้ถูกต้องตามเงื่อนไข

- Input: 
  1. สถานะสมาชิก (Y/N) เอาไว้เช็คเงื่อนไขส่วนลด
  2. จำนวนสินค้า (N) เอาไว้ใช้เป็นจำนวนรอบในการวนลูปรับค่า
  3. ราคาสินค้าแต่ละชิ้นจำนวน N บรรทัด
- Output: ราคารวมสุทธิหลังคิดเงื่อนไขและปัดเศษทศนิยม 2 ตำแหน่ง

เงื่อนไขสำคัญคือ ต้องคำนวณตามขั้นตอนปกติก่อน แล้วค่อยมาจัดการเรื่องการแสดงผลทศนิยมและการปัดเศษให้ตรงกับที่โจทย์ต้องการ
```
...
```text
Step 1: รับค่าสถานะสมาชิกและจำนวนสินค้า จากนั้นวนลูปรับราคาสินค้าเพื่อคำนวณผลรวม
Step 2: เช็คเงื่อนไขสถานะสมาชิกเพื่อคิดส่วนลดตามประเภท
Step 3: ตรวจสอบและจัดการเรื่องการปัดเศษทศนิยมให้ออกมาเป็น 2 ตำแหน่งตามที่โจทย์กำหนด
```
...
```text
วิธีสุดท้ายเหมือนกับแผนแรกครับ แต่ต้องเขียนฟังก์ชันสำหรับจัดการการปัดเศษทศนิยมเพิ่มเติมเอง เพราะฟังก์ชันปัดเศษ built-in แบบปกติ ให้ผลลัพธ์การปัดเศษบางเคสไม่ตรงตามที่โจทย์ต้องการ
```
...
```text
ทดสอบกรณีไม่เป็นสมาชิก (N) และมียอดรวมเข้าเงื่อนไขส่วนลดปกติ เพื่อเช็คคำนวณพื้นฐาน
```
...
```text
ทดสอบกรณีไม่เป็นสมาชิก (N) ที่มียอดรวมเฉียดเงื่อนไข (ยอดรวมไม่ถึง 500) เพื่อเช็คการหลุดเงื่อนไขส่วนลด
```
...
```text
ทดสอบกรณีเป็นสมาชิก (Y) และมียอดเงินเป็นทศนิยม เพื่อเช็คการปัดเศษทศนิยม 2 ตำแหน่งให้ถูกต้อง
```
